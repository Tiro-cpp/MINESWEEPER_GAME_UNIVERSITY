...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_NewGameDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_NewGameDialog_t qt_meta_stringdata_NewGameDialog = {
    {
        QT_MOC_LITERAL(0, 13),  // "NewGameDialog"
        QT_MOC_LITERAL(14, 9),  // "onConfirm"
        QT_MOC_LITERAL(24, 0)   // ""
    },
    "NewGameDialog",
    "onConfirm",
...
Q_CONSTINIT static const uint qt_meta_data_NewGameDialog[] = {
...
Q_CONSTINIT const QMetaObject NewGameDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_NewGameDialog.offsetsAndSizes,
    qt_meta_data_NewGameDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_NewGameDialog_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NewGameDialog, std::true_type>,
        // method 'onConfirm'
